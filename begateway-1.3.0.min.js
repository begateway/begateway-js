...
/*! begateway.js is a library for iframe integration with eComCharge payment software. 
 * begateway by eComCharge 2020-09-07. Version 1.3.0 */

!function(){"use strict";Sentry.init({dsn:"https://ce8fc9d5a4854150b75072cac825e36a@sentry.ecomcharge.com/14"});var s=jQuery.noConflict();function i(){return"<div class='beGatewaySpinner'><div id='circularGbeGateway'><div id='circularGbeGateway_1' class='circularGbeGateway'></div><div id='circularGbeGateway_2' class='circularGbeGateway'></div><div id='circularGbeGateway_3' class='circularGbeGateway'></div><div id='circularGbeGateway_4' class='circularGbeGateway'></div><div id='circularGbeGateway_5' class='circularGbeGateway'></div><div id='circularGbeGateway_6' class='circularGbeGateway'></div><div id='circularGbeGateway_7' class='circularGbeGateway'></div><div id='circularGbeGateway_8' class='circularGbeGateway'></div></div></div></div>"}window.addEventListener("message",function(i){return i.data.url&&setTimeout(function(){try{window.top.location=i.data.url}catch(a){document.location=i.data.url}},500),!1},!1);function a(a){if(!a.url)return!1;this.url=a.url,this.styles=a.style,this.type=a.type,this.anchor=a.id,this.iframeDivId="beGatewayForm";var i,e,t,n=(i=a.url,e=(i.split("?")[1]||"").split("&"),t=void 0,e.forEach(function(a){var i=a.split("=")||[];i[0]&&i[1]&&"token"===i[0].toLowerCase()&&(t=i[1])}),t);this.styles&&n&&(Sentry.setExtras(a),Sentry.captureMessage(n)),a.size?this.size=a.size:this.size={height:480,width:320}}a.prototype.isMobile=function(){return!!(navigator.userAgent.match(/Android/i)||navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/Windows Phone/i))},a.prototype.showSpinner=function(){var a;s('<style type="text/css">#circularGbeGateway{position:relative;width:58px;height:58px;margin:auto}.circularGbeGateway{position:absolute;background-color:#000;width:14px;height:14px;border-radius:9px;-o-border-radius:9px;-ms-border-radius:9px;-webkit-border-radius:9px;-moz-border-radius:9px;animation-name:bounce_circularGbeGateway;-o-animation-name:bounce_circularGbeGateway;-ms-animation-name:bounce_circularGbeGateway;-webkit-animation-name:bounce_circularGbeGateway;-moz-animation-name:bounce_circularGbeGateway;animation-duration:1.1s;-o-animation-duration:1.1s;-ms-animation-duration:1.1s;-webkit-animation-duration:1.1s;-moz-animation-duration:1.1s;animation-iteration-count:infinite;-o-animation-iteration-count:infinite;-ms-animation-iteration-count:infinite;-webkit-animation-iteration-count:infinite;-moz-animation-iteration-count:infinite;animation-direction:normal;-o-animation-direction:normal;-ms-animation-direction:normal;-webkit-animation-direction:normal;-moz-animation-direction:normal}#circularGbeGateway_1{left:0;top:23px;animation-delay:.41s;-o-animation-delay:.41s;-ms-animation-delay:.41s;-webkit-animation-delay:.41s;-moz-animation-delay:.41s}#circularGbeGateway_2{left:6px;top:6px;animation-delay:.55s;-o-animation-delay:.55s;-ms-animation-delay:.55s;-webkit-animation-delay:.55s;-moz-animation-delay:.55s}#circularGbeGateway_3{top:0;left:23px;animation-delay:.69s;-o-animation-delay:.69s;-ms-animation-delay:.69s;-webkit-animation-delay:.69s;-moz-animation-delay:.69s}#circularGbeGateway_4{right:6px;top:6px;animation-delay:.83s;-o-animation-delay:.83s;-ms-animation-delay:.83s;-webkit-animation-delay:.83s;-moz-animation-delay:.83s}#circularGbeGateway_5{right:0;top:23px;animation-delay:.97s;-o-animation-delay:.97s;-ms-animation-delay:.97s;-webkit-animation-delay:.97s;-moz-animation-delay:.97s}#circularGbeGateway_6{right:6px;bottom:6px;animation-delay:1.1s;-o-animation-delay:1.1s;-ms-animation-delay:1.1s;-webkit-animation-delay:1.1s;-moz-animation-delay:1.1s}#circularGbeGateway_7{left:23px;bottom:0;animation-delay:1.24s;-o-animation-delay:1.24s;-ms-animation-delay:1.24s;-webkit-animation-delay:1.24s;-moz-animation-delay:1.24s}#circularGbeGateway_8{left:6px;bottom:6px;animation-delay:1.38s;-o-animation-delay:1.38s;-ms-animation-delay:1.38s;-webkit-animation-delay:1.38s;-moz-animation-delay:1.38s}@keyframes bounce_circularGbeGateway{0%{transform:scale(1)}100%{transform:scale(.3)}}@-o-keyframes bounce_circularGbeGateway{0%{-o-transform:scale(1)}100%{-o-transform:scale(.3)}}@-ms-keyframes bounce_circularGbeGateway{0%{-ms-transform:scale(1)}100%{-ms-transform:scale(.3)}}@-webkit-keyframes bounce_circularGbeGateway{0%{-webkit-transform:scale(1)}100%{-webkit-transform:scale(.3)}}@-moz-keyframes bounce_circularGbeGateway{0%{-moz-transform:scale(1)}100%{-moz-transform:scale(.3)}}</style>').appendTo(s("head")),"overlay"==this.type?s("body").append(i()):(a="#"+this.anchor,s(a).css("position","relative"),s(a).css("height",this.size.height),s(a).append(i())),s(".beGatewaySpinner").hide();s.each({position:"absolute",left:"50%",top:"50%","z-index":"31337","margin-left":"-29px","margin-top":"-29px"},function(a,i){s(".beGatewaySpinner").css(a,i)}),s(".beGatewaySpinner").show()},a.prototype.hideSpinner=function(){s(".beGatewaySpinner").remove()},a.prototype.prepareIframe=function(a){var i=document.createElement("div");s(i).attr("id",this.iframeDivId),this.showSpinner(),s(i).hide();var e=document.createElement("IFRAME");e.setAttribute("src",a),e.setAttribute("frameborder","0"),e.style.display="block",e.style.margin="auto",this.size&&(e.style.width=this.size.width+"px",e.style.height=this.size.height+"px"),i.appendChild(e),this.anchor&&document.getElementById(this.anchor)?document.getElementById(this.anchor).appendChild(i):document.body.appendChild(i);var t=this.styles,n=this.size,o=this;return e.onload=function(){e.contentWindow.postMessage({css:t},"*"),0==s("#closeWindow").length&&(s(".ui-dialog").prepend("<a href='#' id='closeWindow'></div>"),s("a#closeWindow").css("left",n.width),s("a#closeWindow").click(function(a){a.preventDefault(),s("#dialogWindowBeGateway").dialog("close")})),o.hideSpinner(),setTimeout(function(){s(i).show()},100)},e},a.prototype.buildOverlayForm=function(t){var a="#"+this.anchor,n=this.size,o=this,r="dialogWindowBeGateway",i=document.createElement("div");i.setAttribute("id",r),document.body.appendChild(i);var e=new RegExp("([http|https].+/)checkout").exec(this.url)[1]+"stylesheets/jquery-ui.min.css";s("body").append('<link rel="stylesheet" href="'+e+'">'),s(a).on("click.overlayForm",function(a){if(a.preventDefault(),o.isMobile())return window.open(t+"&iframe=phone"),!1;var i=n.width+10,e=n.height+10;s("#"+r).dialog({dialogClass:r,modal:!0,width:i,height:e,show:{effect:"fadeIn"},hide:{effect:"fadeOut"},open:function(){0==s("#"+r).children("iframe").size()&&document.getElementById(r).appendChild(o.prepareIframe(t+"&iframe=overlay")),s("#"+r).css("cssText","width: "+i+"px !important;max-width: "+i+"px !important;max-height:"+e+"px !important;height: "+e+"px !important;overflow-x: hidden; overflow-y: hidden;")}})})},a.prototype.buildInlineForm=function(a){a+="&iframe=inline",this.prepareIframe(a)},a.prototype.buildForm=function(){return"overlay"==this.type?(this.buildOverlayForm(this.url),!1):"inline"==this.type?(this.buildInlineForm(this.url),!1):void 0},window.BeGateway=a}();