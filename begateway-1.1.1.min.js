 ...
 * begateway by eComCharge 2016-04-21. Version 1.1.1 */
!function(){"use strict";function a(a){return console.log("DEBUG: message from iFrame received!"),console.log("THIS is event: "+a),a.data.url&&setTimeout(function(){try{window.top.location.href=a.data.url}catch(b){document.location=a.data.url}},500),!1}window.removeEventListener("message",a,!1),window.addEventListener("message",a,!1);var b=function(a){return a.url?(this.url=a.url,this.styles=a.style,this.type=a.type,this.anchor=a.id,this.iframeDivId="beGatewayForm",void(a.size?this.size=a.size:this.size={height:480,width:320})):!1};b.prototype.isMobile=function(){return navigator.userAgent.match(/Android/i)||navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/Windows Phone/i)?!0:!1},b.prototype.prepareIframe=function(a){var b=document.createElement("div");b.setAttribute("id",this.iframeDivId),b.style.display="none";var c=document.createElement("IFRAME");c.setAttribute("src",a),c.setAttribute("frameborder","0"),c.style.display="block",c.style.margin="auto",this.size&&(c.style.width=this.size.width+"px",c.style.height=this.size.height+"px"),b.appendChild(c),this.anchor&&document.getElementById(this.anchor)?document.getElementById(this.anchor).appendChild(b):document.body.appendChild(b);var d=this.styles,e=this.size;return c.onload=function(){c.contentWindow.postMessage({css:d},"*"),0==$("#closeWindow").size()&&($(".ui-dialog").prepend("<a href='#' id='closeWindow'></div>"),$("a#closeWindow").css("left",e.width),$("a#closeWindow").click(function(a){a.preventDefault(),$("#dialogWindowBeGateway").dialog("close")}))},c},b.prototype.buildOverlayForm=function(a){var b="#"+this.anchor,c=this.size,d=this,e="dialogWindowBeGateway",f=document.createElement("div");f.setAttribute("id",e),document.body.appendChild(f);var g=new RegExp("([http|https].+/)checkout"),h=g.exec(this.url)[1],i=h+"stylesheets/jquery-ui.min.css";$("body").append('<link rel="stylesheet" href="'+i+'">'),$(b).click(function(b){if(b.preventDefault(),d.isMobile())return window.open(d.url),!1;var f=c.width+10,g=c.height+10;$("#"+e).dialog({dialogClass:e,modal:!0,width:f,height:g,show:{effect:"fadeIn"},hide:{effect:"fadeOut"},open:function(){0==$("#"+e).children("iframe").size()&&document.getElementById(e).appendChild(d.prepareIframe(a+"&iframe=overlay")),$("#"+e).css("cssText","width: "+f+"px !important;max-width: "+f+"px !important;max-height:"+g+"px !important;height: "+g+"px !important;overflow-x: hidden; overflow-y: hidden;")}})})},b.prototype.buildInlineForm=function(a){a+="&iframe=inline",this.prepareIframe(a),$("#"+this.iframeDivId).show()},b.prototype.buildForm=function(){return options.style&&(this.styles=options.style),"overlay"==this.type?(this.buildOverlayForm(this.url),!1):"inline"==this.type?(this.buildInlineForm(this.url),!1):void 0},window.BeGateway=b}();