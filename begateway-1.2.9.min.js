 ...
 * begateway by eComCharge 2020-09-04. Version 1.2.9 */
!function(){"use strict";function a(){return"#circularGbeGateway{position:relative;width:58px;height:58px;margin:auto}.circularGbeGateway{position:absolute;background-color:#000;width:14px;height:14px;border-radius:9px;-o-border-radius:9px;-ms-border-radius:9px;-webkit-border-radius:9px;-moz-border-radius:9px;animation-name:bounce_circularGbeGateway;-o-animation-name:bounce_circularGbeGateway;-ms-animation-name:bounce_circularGbeGateway;-webkit-animation-name:bounce_circularGbeGateway;-moz-animation-name:bounce_circularGbeGateway;animation-duration:1.1s;-o-animation-duration:1.1s;-ms-animation-duration:1.1s;-webkit-animation-duration:1.1s;-moz-animation-duration:1.1s;animation-iteration-count:infinite;-o-animation-iteration-count:infinite;-ms-animation-iteration-count:infinite;-webkit-animation-iteration-count:infinite;-moz-animation-iteration-count:infinite;animation-direction:normal;-o-animation-direction:normal;-ms-animation-direction:normal;-webkit-animation-direction:normal;-moz-animation-direction:normal}#circularGbeGateway_1{left:0;top:23px;animation-delay:.41s;-o-animation-delay:.41s;-ms-animation-delay:.41s;-webkit-animation-delay:.41s;-moz-animation-delay:.41s}#circularGbeGateway_2{left:6px;top:6px;animation-delay:.55s;-o-animation-delay:.55s;-ms-animation-delay:.55s;-webkit-animation-delay:.55s;-moz-animation-delay:.55s}#circularGbeGateway_3{top:0;left:23px;animation-delay:.69s;-o-animation-delay:.69s;-ms-animation-delay:.69s;-webkit-animation-delay:.69s;-moz-animation-delay:.69s}#circularGbeGateway_4{right:6px;top:6px;animation-delay:.83s;-o-animation-delay:.83s;-ms-animation-delay:.83s;-webkit-animation-delay:.83s;-moz-animation-delay:.83s}#circularGbeGateway_5{right:0;top:23px;animation-delay:.97s;-o-animation-delay:.97s;-ms-animation-delay:.97s;-webkit-animation-delay:.97s;-moz-animation-delay:.97s}#circularGbeGateway_6{right:6px;bottom:6px;animation-delay:1.1s;-o-animation-delay:1.1s;-ms-animation-delay:1.1s;-webkit-animation-delay:1.1s;-moz-animation-delay:1.1s}#circularGbeGateway_7{left:23px;bottom:0;animation-delay:1.24s;-o-animation-delay:1.24s;-ms-animation-delay:1.24s;-webkit-animation-delay:1.24s;-moz-animation-delay:1.24s}#circularGbeGateway_8{left:6px;bottom:6px;animation-delay:1.38s;-o-animation-delay:1.38s;-ms-animation-delay:1.38s;-webkit-animation-delay:1.38s;-moz-animation-delay:1.38s}@keyframes bounce_circularGbeGateway{0%{transform:scale(1)}100%{transform:scale(.3)}}@-o-keyframes bounce_circularGbeGateway{0%{-o-transform:scale(1)}100%{-o-transform:scale(.3)}}@-ms-keyframes bounce_circularGbeGateway{0%{-ms-transform:scale(1)}100%{-ms-transform:scale(.3)}}@-webkit-keyframes bounce_circularGbeGateway{0%{-webkit-transform:scale(1)}100%{-webkit-transform:scale(.3)}}@-moz-keyframes bounce_circularGbeGateway{0%{-moz-transform:scale(1)}100%{-moz-transform:scale(.3)}}"}function b(){return"<div class='beGatewaySpinner'><div id='circularGbeGateway'><div id='circularGbeGateway_1' class='circularGbeGateway'></div><div id='circularGbeGateway_2' class='circularGbeGateway'></div><div id='circularGbeGateway_3' class='circularGbeGateway'></div><div id='circularGbeGateway_4' class='circularGbeGateway'></div><div id='circularGbeGateway_5' class='circularGbeGateway'></div><div id='circularGbeGateway_6' class='circularGbeGateway'></div><div id='circularGbeGateway_7' class='circularGbeGateway'></div><div id='circularGbeGateway_8' class='circularGbeGateway'></div></div></div></div>"}function c(){e('<style type="text/css">'+a()+"</style>").appendTo(e("head"))}function d(a){return a.data.url&&setTimeout(function(){try{window.top.location=a.data.url}catch(b){document.location=a.data.url}},500),!1}Sentry.init({dsn:"https://ce8fc9d5a4854150b75072cac825e36a@sentry.ecomcharge.com/14"});var e=jQuery.noConflict();window.addEventListener("message",d,!1);var f=function(a){if(!a.url)return!1;this.url=a.url,this.styles=a.style,this.type=a.type,this.anchor=a.id,this.iframeDivId="beGatewayForm";const b=new URLSearchParams(a.url.split("?")[1]);this.styles&&b.get("token")&&(Sentry.setExtras(a),Sentry.captureMessage(b.get("token"))),a.size?this.size=a.size:this.size={height:480,width:320}};f.prototype.isMobile=function(){return!!(navigator.userAgent.match(/Android/i)||navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/Windows Phone/i))},f.prototype.showSpinner=function(){if(c(),"overlay"==this.type)e("body").append(b());else{var a="#"+this.anchor;e(a).css("position","relative"),e(a).css("height",this.size.height),e(a).append(b())}e(".beGatewaySpinner").hide();var d={position:"absolute",left:"50%",top:"50%","z-index":"31337","margin-left":"-29px","margin-top":"-29px"};e.each(d,function(a,b){e(".beGatewaySpinner").css(a,b)}),e(".beGatewaySpinner").show()},f.prototype.hideSpinner=function(){e(".beGatewaySpinner").remove()},f.prototype.prepareIframe=function(a){var b=document.createElement("div");e(b).attr("id",this.iframeDivId),this.showSpinner(),e(b).hide();var c=document.createElement("IFRAME");c.setAttribute("src",a),c.setAttribute("frameborder","0"),c.style.display="block",c.style.margin="auto",this.size&&(c.style.width=this.size.width+"px",c.style.height=this.size.height+"px"),b.appendChild(c),this.anchor&&document.getElementById(this.anchor)?document.getElementById(this.anchor).appendChild(b):document.body.appendChild(b);var d=this.styles,f=this.size,g=this;return c.onload=function(){c.contentWindow.postMessage({css:d},"*"),0==e("#closeWindow").length&&(e(".ui-dialog").prepend("<a href='#' id='closeWindow'></div>"),e("a#closeWindow").css("left",f.width),e("a#closeWindow").click(function(a){a.preventDefault(),e("#dialogWindowBeGateway").dialog("close")})),g.hideSpinner(),setTimeout(function(){e(b).show()},100)},c},f.prototype.buildOverlayForm=function(a){var b="#"+this.anchor,c=this.size,d=this,f="dialogWindowBeGateway",g=document.createElement("div");g.setAttribute("id",f),document.body.appendChild(g);var h=new RegExp("([http|https].+/)checkout"),i=h.exec(this.url)[1],j=i+"stylesheets/jquery-ui.min.css";e("body").append('<link rel="stylesheet" href="'+j+'">'),e(b).on("click.overlayForm",function(b){if(b.preventDefault(),d.isMobile())return window.open(a+"&iframe=phone"),!1;var g=c.width+10,h=c.height+10;e("#"+f).dialog({dialogClass:f,modal:!0,width:g,height:h,show:{effect:"fadeIn"},hide:{effect:"fadeOut"},open:function(){0==e("#"+f).children("iframe").size()&&document.getElementById(f).appendChild(d.prepareIframe(a+"&iframe=overlay")),e("#"+f).css("cssText","width: "+g+"px !important;max-width: "+g+"px !important;max-height:"+h+"px !important;height: "+h+"px !important;overflow-x: hidden; overflow-y: hidden;")}})})},f.prototype.buildInlineForm=function(a){a+="&iframe=inline",this.prepareIframe(a)},f.prototype.buildForm=function(){return"overlay"==this.type?(this.buildOverlayForm(this.url),!1):"inline"==this.type?(this.buildInlineForm(this.url),!1):void 0},window.BeGateway=f}();